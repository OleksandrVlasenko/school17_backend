...
import { router as StatutLinkRouter } from "./routes/api/statutLink-router.js";
import { router as NewsRouter } from "./routes/api/news-router.js";
...
app.use("/api/statut", StatutLinkRouter);
